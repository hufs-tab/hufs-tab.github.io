...
import logo from '../styles/tab_logo.png';
import bg from '../styles/samuel-zeller-337030-unsplash.jpg'

const AboutUs = () => (
    <div id="home" className="section">
        <img id="bg-img" src={bg}/>
        <img max-width="400px" src={logo} alt="탭 로고"/>
        <h1>TAB</h1>
        <h2>Talking and Books</h2>
        <h2>한국외대 컴퓨터 학회</h2>
        <br></br>
